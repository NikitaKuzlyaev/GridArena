...
function SolveContest() {
  ...
  return (
    <div style={{
      ...
      margin: '0px auto',
      padding: '0px',
      // background: '#fff', // убираем фон
      // borderRadius: '12px', // убираем скругления
      // boxShadow: '0 4px 16px rgba(0,0,0,0.1)', // убираем тень
      display: 'flex',
      flexDirection: 'row',
      gap: 32,
                      ...
                      return (
                        <td
                          ...
                          style={{
                            ...
                            fontSize: 14,
                            // borderRadius: 1, // малое скругление
                            // boxShadow: card ? '2px 4px 8px 0 rgba(60,60,60,0.07)' : 'none', // небольшая тень снизу и справа
                          }}
                          onClick={() => {
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
              {myProblems.map(problem => (
                <div key={problem.selectedProblemId} style={{
                  ...
                  borderRadius: 1, // малое скругление
                  padding: 24,
                  // boxShadow: '2px 0px 0px #2BAF90',
                  maxWidth: 700,
                  margin: '0 auto',
                }}>
                  <div style={{ marginBottom: 36, fontWeight: 500, color: '#333' }}>
                  ...
                  <div style={{ display: 'flex', gap: 12 }}>
                    ...
                    <button
                      style={{
                        ...
                        outline: '1px dashed rgba(80, 94, 124, 0.5)', // пунктирная обводка
                        outlineOffset: '0px',
                      }}
                      onClick={async () => {
                        const token = localStorage.getItem('access_token');
